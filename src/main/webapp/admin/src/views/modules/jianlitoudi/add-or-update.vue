<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="所在学校" prop="suozaixuexiao">
          <el-input v-model="ruleForm.suozaixuexiao" 
              placeholder="所在学校" clearable  :readonly="ro.suozaixuexiao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="所在学校" prop="suozaixuexiao">
              <el-input v-model="ruleForm.suozaixuexiao" 
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="简历信息" prop="jianlixinxi">
          <file-upload
          tip="点击上传简历信息"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.jianlixinxi?ruleForm.jianlixinxi:''"
          @change="jianlixinxiUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.jianlixinxi" label="简历信息" prop="jianlixinxi">
            <el-button type="text" size="small" @click="download(ruleForm.jianlixinxi)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="备注信息" prop="beizhuxinxi">
          <el-input v-model="ruleForm.beizhuxinxi" 
              placeholder="备注信息" clearable  :readonly="ro.beizhuxinxi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="备注信息" prop="beizhuxinxi">
              <el-input v-model="ruleForm.beizhuxinxi" 
                placeholder="备注信息" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.yuanxizhuanye = true;
          ...
          if(o=='jianlixinxi'){
            this.ruleForm.jianlixinxi = obj[o];
	    this.ro.jianlixinxi = true;
            continue;
          }
          if(o=='toudishijian'){
      ...
      this.$http({
		...
		if(json.suozaixuexiao!=''&&json.suozaixuexiao){
              		this.ruleForm.suozaixuexiao = json.suozaixuexiao
		}
		if(json.yuanxizhuanye!=''&&json.yuanxizhuanye){
              		this.ruleForm.yuanxizhuanye = json.yuanxizhuanye
		}
        } else {
    ...
    jianlixinxiUploadChange(fileUrls) {
	this.ruleForm.jianlixinxi = fileUrls;
			this.addEditUploadStyleChange()
    },
