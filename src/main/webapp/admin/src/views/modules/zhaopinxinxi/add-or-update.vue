      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="公司邮箱" prop="gongsiyouxiang">
          <el-input v-model="ruleForm.gongsiyouxiang" 
              placeholder="公司邮箱" clearable  :readonly="ro.gongsiyouxiang"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="公司邮箱" prop="gongsiyouxiang">
              <el-input v-model="ruleForm.gongsiyouxiang" 
                placeholder="公司邮箱" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
	...
	this.ruleForm.zhiweiyaoqiu = this.ruleForm.zhiweiyaoqiu.replace(reg,'../../../ssmg1el1/upload');
	this.ruleForm.gongzidaiyu = this.ruleForm.gongzidaiyu.replace(reg,'../../../ssmg1el1/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
