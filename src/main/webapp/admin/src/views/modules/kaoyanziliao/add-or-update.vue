<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="易错提醒" prop="yicuotixing">
          <file-upload
          tip="点击上传易错提醒"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.yicuotixing?ruleForm.yicuotixing:''"
          @change="yicuotixingUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.yicuotixing" label="易错提醒" prop="yicuotixing">
            <el-button type="text" size="small" @click="download(ruleForm.yicuotixing)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="学校招录比" prop="xuexiaozhaolubi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.xuexiaozhaolubi" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.xuexiaozhaolubi" label="学校招录比" prop="xuexiaozhaolubi">
                    <span v-html="ruleForm.xuexiaozhaolubi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jianjie = true;
          ...
          if(o=='yicuotixing'){
            this.ruleForm.yicuotixing = obj[o];
	    this.ro.yicuotixing = true;
            continue;
          }
          if(o=='xuexiaozhaolubi'){
            this.ruleForm.xuexiaozhaolubi = obj[o];
	    this.ro.xuexiaozhaolubi = true;
            continue;
          }
          if(o=='beizhuxinxi'){
	...
	this.ruleForm.xuexiaozhaolubi = this.ruleForm.xuexiaozhaolubi.replace(reg,'../../../ssmg1el1/upload');
    ...
    yicuotixingUploadChange(fileUrls) {
	this.ruleForm.yicuotixing = fileUrls;
			this.addEditUploadStyleChange()
    },
