<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="答题技巧" prop="datijiqiao">
          <file-upload
          tip="点击上传答题技巧"
          action="file/upload"
          :limit="1"
          :multiple="true"
          :fileUrls="ruleForm.datijiqiao?ruleForm.datijiqiao:''"
          @change="datijiqiaoUploadChange"
          ></file-upload>
        </el-form-item>  
        <div v-else>
          <el-form-item v-if="ruleForm.datijiqiao" label="答题技巧" prop="datijiqiao">
            <el-button type="text" size="small" @click="download(ruleForm.datijiqiao)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="职位表" prop="zhiweibiao">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.zhiweibiao" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.zhiweibiao" label="职位表" prop="zhiweibiao">
                    <span v-html="ruleForm.zhiweibiao"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jianjie = true;
          ...
          if(o=='datijiqiao'){
            this.ruleForm.datijiqiao = obj[o];
	    this.ro.datijiqiao = true;
            continue;
          }
          if(o=='zhiweibiao'){
            this.ruleForm.zhiweibiao = obj[o];
	    this.ro.zhiweibiao = true;
            continue;
          }
          if(o=='beizhuxinxi'){
	...
	this.ruleForm.zhiweibiao = this.ruleForm.zhiweibiao.replace(reg,'../../../ssmg1el1/upload');
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `kaogongziliao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.kaogongziliaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
    ...
    datijiqiaoUploadChange(fileUrls) {
	this.ruleForm.datijiqiao = fileUrls;
			this.addEditUploadStyleChange()
    },
